...
(function ($) {
  ...
  if ($(".get-insuracne-two__form").length) {
    $(".get-insuracne-two__form").validate({
      ...
      submitHandler: function (form) {
        ...
        spinner.show();
        sessionStorage.setItem('lead', JSON.stringify(templateParams))
        form.reset();

        const activeService = $('#lead-forms-application').children('.active-btn').attr("data-tab");
        
        switch(activeService){
          case "#home_loan":
            window.location.href = '/home-loan.html#start_your_application';
            break;
          case "#refinance":
            window.location.href = '/refinance.html#start_your_application';
            break;
          case "#reverse_mortgage":
            window.location.href = '/reverse-mortgage.html#start_your_application';
            break;
          case "#home_improvement":
            window.location.href = '/home-improvement.html#start_your_application';
            break;
          case "#home_warranty":
            window.location.href = '/home-warranty.html#start_your_application';
            break;
        }
        // window.location.href = '/home-loan.html#start_your_application';
        spinner.hide();
        ...
        fetch(scriptURL, {
          ...
          .then((response) => {
            ...
            Swal.fire({
              icon: 'success',
              title: 'Thank you...!',
              text: 'We received your message get back to you soon',
              confirmButtonColor: '#002b80',
...
$.validator.addMethod("phoneUSForContactForm", function(Phone, element) {
...
$.validator.addMethod("minAgeForContactForm", function(value, element) {
  const activeService = $('#lead-forms-application').children('.active-btn').attr("data-tab");
  var min = activeService === "#reverse_mortgage"?60:20;
  var today = new Date();
